  ...
  return (
    <section className="relative bg-black text-white flex items-center justify-center text-center overflow-hidden min-h-[40vh] sm:min-h-[50vh] lg:min-h-[60vh] px-4 sm:px-6 lg:px-12 py-6 sm:py-12 lg:py-16">  
      <div className="absolute inset-0 -z-0">
        <div className="relative w-[120%] -ml-[10%] aspect-[16/9] sm:w-full sm:ml-0 top-[10%] sm:top-0">
          <Image
            src="/arrow.png"
            alt="Background Arrow"
            fill
            className="opacity-25 pointer-events-none object-contain scale-[1.2] sm:scale-100 -translate-x-[5%] translate-y-[15%] sm:translate-y-0 sm:translate-x-0"
            sizes="100vw"
            quality={100}
          />
        </div>
